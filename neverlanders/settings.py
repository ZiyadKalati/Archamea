"""
Django settings for neverlanders project.
...
ROOT_URLCONF = 'neverlanders.urls'
...
WSGI_APPLICATION = 'neverlanders.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = '/var/www/neverlanders.com/static/'
